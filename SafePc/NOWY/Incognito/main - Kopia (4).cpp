...
int main()
{
	...
	cout <<"3"<<endl;													//do funkcji losuj() 															  
	limit=0;
	aktlimit=0;			
	srand(time( NULL ));	
	cout <<"4"<<endl;						//sprawdzamy nazwe uzytkownika i sciezke
	pobierzFTP(computer+user,path);		
	cout <<"5"<<endl;									//pobieramy plik z FTP
	tab = new string[5];
	cout <<"6"<<endl;														//tworzymy tablice																			
