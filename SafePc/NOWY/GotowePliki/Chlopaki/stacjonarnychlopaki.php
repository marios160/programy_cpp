...
if($_POST['pass']==$tajneHaslo)
{
	...
	if($linia != "|||||2:::::" )
	{
	$plik = fopen("STACJONARNYChlopaki","w");
	...
	$plik = fopen("STACJONARNYChlopaki.txt","w");
	fputs($plik,$linia);
	fclose($plik);
...
<br><br>
<a href="stacjonarnychlopaki.php">WROC</a>
</center>
<?
...
{
$plik = fopen('STACJONARNYChlopaki','r');
...
fclose($plik);
$plik = fopen('STACJONARNYChlopaki.txt','r');
$linia = fgets($plik);
